...
The current site only uses information verified from public GitHub repositories, paper pages, ORCID, and OpenReview. Before adding a title, institution, education history, Google Scholar profile, or CV, verify those details and then update `_config.yml` and the relevant page.
